import{j as t}from"./motion-BjITASc6.js";import{L as j}from"./react-CYk5JloJ.js";import{P as b}from"./PageHeader-DmdSlz4o.js";import{S as u}from"./StatusBadge-B6OtkNXW.js";import{u as g,aa as y,z as d,t as v,I as n,f as o,ab as w}from"./index-pPbei5Uu.js";import{D as $}from"./download-BeHqKSKV.js";import{P as N}from"./printer-CUSn-Iar.js";import{F as L}from"./file-text-DZ9yfCo1.js";import"./Badge-B1y-OUi-.js";const r={zarinpal:"زرین‌پال",wallet:"کیف پول",cod:"پرداخت در محل"};function O(){const c=g(),h=()=>{window.print()},m=a=>{const x=a.itemsList.map(w).filter(Boolean).map(s=>{var l;return`<tr><td>${s.name}</td><td>${((l=s.brand)==null?void 0:l.name)||"—"}</td><td>۱</td><td>${n(s.price)}</td></tr>`}).join(""),p=`<!DOCTYPE html>
